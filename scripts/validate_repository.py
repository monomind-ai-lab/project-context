...
REQUIRED = (
    ...
    # Crawler-facing files. robots.txt is a static source copied verbatim;
    # sitemap.xml and llms.txt are generated by build_site.py from the same
    # page metadata as the pages, so they cannot drift from what is served.
    ...
    "web/content/addons/meta.json",
    "web/content/addons/page.html",
    "web/content/addons/page.css",
    "web/content/addons/i18n.js",
