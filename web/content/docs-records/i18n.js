/* =====================================================================
   ...
   widget, footer, sign-off band) carries data-i18n keys here; the page
   body is plain English and machine-translated. If this page is ever
   promoted to the hand-translated tier, add `ko` and `zh-TW` blocks with
   the SAME keys — the build enforces parity for every locale present.
